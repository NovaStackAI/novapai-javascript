...
NovaPAI is fully OpenAI-compatible. Use your language's standard OpenAI SDK — only change the `base_url`:

```javascript
// All languages supported via standard OpenAI SDK!
// Just point base_url to https://api.novapai.ai/router/v1
```
